...
class insert(forms.Form):
    ...
    Substanceabuse = forms.CharField(max_length=40,widget=forms.Select(choices=[('Nil', 'Nil'), ('Any 1', 'Any 1'),('Both', 'Both')]))
    ...
    Chemoagent = forms.IntegerField()
    Dosingagent = forms.CharField(max_length=20, widget=forms.Select(choices=[("QW","QW"),("Q3W","Q3W"),("Q3W,Q2W","Q3W,Q2W"),("Q2W,QW","Q2W,QW")]))
    ...
    SocialSupport = forms.CharField(max_length=20, widget=forms.Select(choices=[("Good", "Good"), ("Poor", "Poor"),("NIL","NIL")]))
    MentalState = forms.CharField(max_length=20, widget=forms.Select(choices=[('Normal ,stable', 'Normal ,stable'), ("Depressed ,stable", "Depressed ,stable"), ("Emotional/unstable", "Emotional/unstable"),("Psychiatric illness", "Psychiatric illness")]))
    ...
    CancerType = forms.CharField (max_length=100,widget=forms.Select(choices=[("Carcinoma", "Carcinoma") , ("Carcinosarcoma", "Carcinosarcoma"),("Sarcoma", "Sarcoma")]))
    Gradeg = forms.CharField(max_length=100, widget=forms.Select(choices=[("Low Grade", "Low Grade"), ("High Grade", "High Grade")]))
    StageBurden = forms.CharField(max_length=100,widget=forms.Select(choices=[("None", "None"), ("Low Tumour Burden", "Low Tumour Burden"), ("High Tumour Burden", "High Tumour Burden")]))
    ChemoTolerance = forms.CharField(max_length=100,widget=forms.Select(choices=[("Good", "Good"), ("Fatigue,neutropenia(G1,2),no fever", "Fatigue,neutropenia(G1,2),no fever"), ("Febrile Neutropenia G3/4", "Febrile Neutropenia G3/4")]))
